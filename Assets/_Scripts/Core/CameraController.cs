...
/// <summary>
/// A professional-grade 2D follow camera. It includes smooth damping, look-ahead,
...
public class CameraController : MonoBehaviour
{
    ...
    [Tooltip("The Rigidbody2D of the target the camera should follow (the Player).")]
    ...
    private void LateUpdate()
    {
        ...
        float targetX = _target.position.x + _lookAheadDistance;
