...
/// <summary>
/// Defines the possible states the player can be in.
/// </summary>
public enum PlayerState
{
    Idle,       // Player is stationary, waiting for input to start the run.
    Running,
    Jumping,
    Falling,
    Sliding,    // Player is sliding with a low profile and speed boost.
    Flapping,   // Player is in an airborne, Flappy Bird-style movement mode.
    Flying      // Player has full vertical control and can speed burst.
}
...
public class PlayerController : MonoBehaviour
{
    ...
    private PlayerStats _playerStats; // Reference to the PlayerStats component
    ...
    private readonly int _animTriggerSpinMove = Animator.StringToHash("triggerSpinMove");
    private readonly int _animTriggerNoseDive = Animator.StringToHash("triggerNoseDive");
    private readonly int _animTriggerBarrelRoll = Animator.StringToHash("triggerBarrelRoll");
