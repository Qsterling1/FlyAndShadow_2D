...
public class PlayerStats : MonoBehaviour
{
    ...
    // can easily call its functions (e.g., PlayerStats.instance.ModifyHealth(-10)).
    ...
    [Tooltip("The SpriteRenderer of the player character. Used for the flashing effect when invincible.")]
    ...
    /// <summary>
    /// A coroutine that makes the player invincible and flashes their sprite for a set duration.
    /// </summary>
    private IEnumerator InvincibilityCoroutine()
    {
        ...
        // Ensure the sprite is visible at the end of the coroutine.
...
public void CancelInvincibility()
{
    ...
    _spriteRenderer.enabled = true; // Ensure sprite is visible
    _isInvincible = false;
}
